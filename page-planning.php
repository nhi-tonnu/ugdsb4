...
<?php $has_left = FALSE; ?>
<?php $has_right = FALSE; ?>
<?php if (is_active_sidebar('sidebar-planning') || has_nav_menu('left') || has_nav_menu('planning_menu')) {$has_left = TRUE;} ?>
...
<?php
    ...
    if (has_nav_menu('planning_menu')){
        /*wp_nav_menu(array(  
            'theme_location' => 'planning_menu',   // This will be different for you. 
            'container_id' => 'plamenu', 
            'container_class' => 'ugdsb',
            'walker' => new CSS_Menu_Maker_Walker()
        )); */
        /*if(function_exists('ubermenu')){
            ubermenu( 'planning_menu' , array( 'theme_location' => 'planning_menu' ));
        }else{
           wp_nav_menu(array(
		'theme_location' => 'planning_menu', 
		'menu_class' => '', 
		'container' => false));
        }
        */
		bellows( 'main' , array( 'theme_location' => 'planning_menu' ) );
		
    }
	else{
       get_sidebar('lmenu');//display left menu, sidebar-lmenu.php
    }
    get_sidebar('planning');//display sidebar-left.php
    echo '</div>';
