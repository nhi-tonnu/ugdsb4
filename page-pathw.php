 ...
 *
 * This is the template that displays Pathways page with its specific widgets
 *
 * @package ugdsb4
 */
?>
...
<?php
    ...
    if (has_nav_menu('pathw_menu')){
		bellows( 'main' , array( 'theme_location' => 'pathw_menu' ) ); 
    }else{
       get_sidebar('lmenu');//display left menu, sidebar-lmenu.php
    }
    get_sidebar('pathw');//display sidebar-left.php
    echo '</div>';
