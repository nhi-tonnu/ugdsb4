 ...
 *
 * This is the template that displays Program page with Programs's specific widgets
 *
 * @package ugdsb4
 */
?>
...
<?php $has_left = FALSE; ?>
<?php $has_right = FALSE; ?>
<?php if (is_active_sidebar('sidebar-programs') || has_nav_menu('left') || has_nav_menu('program_menu')) {$has_left = TRUE;} ?>
...
<?php
    ...
    echo '<div class="col-sm-3 col-sm-pull-7 ldiv" id="program">';
        ...
        /*wp_nav_menu(array(  
			...
			bellows( 'main' , array( 'menu' => 18 ) ); //program menu id is 18 
        }else{
          get_sidebar('lmenu');//display left menu, sidebar-lmenu.php
        }
   
        get_sidebar('programs');//display sidebar-left.php
    echo '</div>';
