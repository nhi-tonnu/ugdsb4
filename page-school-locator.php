...
/**
/**
 * Template Name: School Locator (no sidebar)
 *
 * This is the template that displays full width page for school locator without sidebar
 *
 * @package ugdsb4
 */
?>
<?php get_header('nobreadcrumb'); ?>
...
<?php
    ...
    elseif (($has_left == FALSE) and ($has_right == FALSE)):
      echo '<div class="col-md-12" id="mainContent" style="margin-top:-10px;">';
    endif;
    ?>
