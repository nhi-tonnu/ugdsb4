 ...
 *
 * This is the template that displays Community page with Community's specific widgets
 *
 * @package ugdsb4
 */
?>
...
<?php $has_left = FALSE; ?>
<?php $has_right = FALSE; ?>
<?php if (is_active_sidebar('sidebar-community') || has_nav_menu('left') || has_nav_menu('community_menu')) {$has_left = TRUE;} ?>
...
<?php
    ...
    echo '<div class="col-sm-3 col-sm-pull-7 ldiv" id="community">';
		...
		bellows( 'main' , array( 'theme_location' => 'community_menu' ) ); 
		
        }else{
          get_sidebar('lmenu');//display left menu, sidebar-lmenu.php
        }
        get_sidebar('community');//display sidebar-left.php
    echo '</div>';
