 ...
 *
 * This is the template that displays Students page with Students's specific widgets
 *
 * @package ugdsb4
 */
?>
...
<?php $has_left = FALSE; ?>
<?php $has_right = FALSE; ?>
<?php if (is_active_sidebar('sidebar-students') || has_nav_menu('left')|| has_nav_menu('student_menu')) {$has_left = TRUE;} ?>
...
<?php
    ...
    # left column
    if (($has_left == TRUE) and ($has_right == TRUE)):
    echo '<div class="col-sm-3 col-sm-pull-7 ldiv" id="student">';
        if (has_nav_menu('student_menu')){
        /*wp_nav_menu(array(  
            'theme_location' => 'student_menu',   // This will be different for you. 
            'container_id' => 'stumenu', 
            'container_class' => 'ugdsb',
            'walker' => new CSS_Menu_Maker_Walker()
        )); */
			bellows( 'main' , array( 'menu' => 19 ) ); //student menu id 
        }else{
          get_sidebar('lmenu');//display left menu, sidebar-lmenu.php
        }
        get_sidebar('students');//display sidebar-left.php
    echo '</div>';

    # Just left sidebar
    elseif (($has_left == TRUE) and ($has_right == FALSE)):
      echo '<div class="col-sm-3 col-sm-pull-9 ldiv" id="student">';
          if (has_nav_menu('student_menu')){
          /*wp_nav_menu(array(  
            'theme_location' => 'student_menu',   // This will be different for you. 
            'container_id' => 'stumenu', 
