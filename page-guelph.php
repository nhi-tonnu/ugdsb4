<?php
/**
 * Template Name: Interest & Leisure (Guelph) Page
 *
 * This is the template that displays page with Interest and Leisure 's specific widgets
 *
 * @package ugdsb4
 */
?>
...
<?php $has_left = FALSE; ?>
<?php $has_right = FALSE; ?>
<?php if (is_active_sidebar('sidebar-cont-guelph') || has_nav_menu('left') || has_nav_menu('parent_menu')) {$has_left = TRUE;} ?>
    ...
    echo '<div class="col-sm-3 col-sm-pull-7 ldiv" id="parent">';
         if (has_nav_menu('parent_menu')){
          /*wp_nav_menu(array(  
		    ...
		    bellows( 'main' , array( 'menu' => 15 ) );//id of menu for guelph is 15
        }else{
          //get_sidebar('lmenu');//display left menu, sidebar-lmenu.php
        }
        get_sidebar('cont-guelph');//display sidebar-left.php
    echo '</div>';
    ...
    elseif (($has_left == TRUE) and ($has_right == FALSE)):
      echo '<div class="col-sm-3 col-sm-pull-9 ldiv" id="parent">';
       if (has_nav_menu('parent_menu')){
		...
		bellows( 'main' , array( 'menu' => 14 ) );//id of menu for guelph is 14
    }else{
       //get_sidebar('lmenu');//display left menu, sidebar-lmenu.php
    }
      get_sidebar('cont-guelph');//display sidebar-left.php
