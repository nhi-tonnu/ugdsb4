 ...
 *
 * This is the template that displays Other page with its specific widgets
 *
 * @package ugdsb4
 */
?>
...
<?php $has_left = FALSE; ?>
<?php $has_right = FALSE; ?>
<?php if (is_active_sidebar('sidebar-other') || has_nav_menu('left') || has_nav_menu('other_menu')) {$has_left = TRUE;} ?>
...
<?php
    ...
    if (has_nav_menu('other_menu')){
        /*wp_nav_menu(array(  
            'theme_location' => 'other_menu',   // This will be different for you. 
            'container_id' => 'plamenu', 
            'container_class' => 'ugdsb',
            'walker' => new CSS_Menu_Maker_Walker()
        )); */
	     bellows( 'main' , array( 'theme_location' => 'other_menu' ) ); 
    }else{
       get_sidebar('lmenu');//display left menu, sidebar-lmenu.php
    }
    get_sidebar('other');//display sidebar-left.php
    echo '</div>';
