 ...
 *
 * This is the template that displays Board page with Board's specific widgets
 *
 * @package ugdsb4
 */
?>
...
<?php $has_left = FALSE; ?>
<?php $has_right = FALSE; ?>
<?php if (is_active_sidebar('sidebar-left') || has_nav_menu('left') || has_nav_menu('board_menu')) {$has_left = TRUE;} ?>
...
<?php
    ...
    if (has_nav_menu('board_menu')){
       //wp_nav_menu(array('theme_location' => 'board_menu', 'menu_class' => 'sidemenu', 'container' => false));
        /*wp_nav_menu(array(  
            'theme_location' => 'board_menu',   // This will be different for you. 
            'container_id' => 'cssmenu', 
            'container_class' => 'ugdsb',
            'walker' => new CSS_Menu_Maker_Walker()
        )); */
		bellows( 'main' , array( 'theme_location' => 'board_menu' ) ); 
    ...
    get_sidebar('board');//display sidebar-left.php
    echo '</div>';

    # Just left sidebar
    elseif (($has_left == TRUE) and ($has_right == FALSE)):
      echo '<div class="col-sm-3 col-sm-pull-9 ldiv" id="board">';
