...
<?php $has_left = FALSE; ?>
<?php $has_right = FALSE; ?>
<?php if (is_active_sidebar('sidebar-schools') || has_nav_menu('left') || has_nav_menu('school_menu')) {$has_left = TRUE;} ?>
...
<?php
    ...
    if (has_nav_menu('school_menu')){
        /*wp_nav_menu(array(  
            'theme_location' => 'school_menu',   // This will be different for you. 
    ...
    get_sidebar('schools');//display sidebar-left.php
    echo '</div>';
