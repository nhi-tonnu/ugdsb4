...
<div id="top-row" class="footer"><!-- TOP ROW -->
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-4 col-sm-4" id="top-row-left">
              ...
              <address>
                ...
                Email:<a href="mailto:inquiry@ugdsb.on.ca">inquiry@ugdsb.on.ca</a>
         ...
         <a target="_blank" href="<?php echo esc_url(of_get_option('social_map', true)); ?>" title="Google Map" ><i class="social-icon fa fa-map-marker"></i><span class="sr-only">Google Map</span></a>
               <?php } ?>
               <?php if ( of_get_option('social_email', true) != "") { ?>
         <a href="mailto:<?php echo of_get_option('social_email', true); ?>" title="Email Address" ><i class="social-icon fa fa-envelope-square"></i><span class="sr-only">Email Us</span></a>
               <?php } ?>
                <?php if ( of_get_option('social_facebook', true) != "") { ?>
         <a target="_blank" href="<?php echo esc_url(of_get_option('social_facebook', true)); ?>" title="Facebook" ><i class="social-icon fa fa-facebook-square"></i><span class="sr-only">Follow Us on Facebook</span></a>
               <?php } ?>
              <?php if ( of_get_option('social_twitter', true) != "") { ?>
         <a target="_blank" href="<?php echo esc_url(of_get_option('social_twitter', true)); ?>" title="Twitter" ><i class="social-icon fa fa-twitter-square"></i><span class="sr-only">Follow Us on Twitter</span></a>
               <?php } ?>
              
               <?php if ( of_get_option('social_instagram', true) != "") { ?>
         <a target="_blank" href="<?php echo esc_url(of_get_option('social_instagram', true)); ?>" title="Instagram" ><i class="social-icon fa fa-instagram"></i><span class="sr-only">Follow Us on Instagram</span></a>
               <?php } ?>
               
                 <?php if ( of_get_option('social_google', true) != "") { ?>
         <a target="_blank" href="<?php echo esc_url(of_get_option('social_google', true)); ?>" title="Google Plus" ><i class="social-icon fa fa-google-plus-square"></i><span class="sr-only">Follow Us on Google Plus</span></a>
               <?php } ?>
               <?php if ( of_get_option('social_feed', true) != "") { ?>
         <a target="_blank" href="<?php echo esc_url(of_get_option('social_feed', true)); ?>" title="RSS Feeds" ><i class="social-icon fa fa-rss-square"></i><span class="sr-only">Follow Us on FeedBurner</span></a>
               <?php } ?>
               <?php if ( of_get_option('social_pinterest', true) != "") { ?>
         <a target="_blank" href="<?php echo esc_url(of_get_option('social_pinterest', true)); ?>" title="Pinterest" ><i class="social-icon fa fa-pinterest-square"></i><span class="sr-only">Follow Us on Pinterest</span></a>
               <?php } ?>
                 <?php if ( of_get_option('social_linkedin', true) != "") { ?>
         <a target="_blank" href="<?php echo esc_url(of_get_option('social_linkedin', true)); ?>" title="LinkedIn" ><i class="social-icon fa fa-linkedin-square"></i><span class="sr-only">Follow Us on LinkedIn</span></a>
               <?php } ?>
               <?php if ( of_get_option('social_youtube', true) != "") { ?>
         <a target="_blank" href="<?php echo esc_url(of_get_option('social_youtube', true)); ?>" title="YouTube" ><i class="social-icon fa fa-youtube-square"></i><span class="sr-only">Follow Us on YouTube</span></a>
               <?php } ?>
               <?php if ( of_get_option('social_flickr', true) != "") { ?>
         <a target="_blank" href="<?php echo esc_url(of_get_option('social_flickr', true)); ?>" title="Flickr" ><i class="social-icon fa fa-flickr"></i><span class="sr-only">Follow Us on Flickr</span></a>
               <?php } ?>
